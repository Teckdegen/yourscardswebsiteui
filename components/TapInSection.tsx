...
const SLIDES = [
  {
    ...
    body: "Visa debit. 50M+ merchants. Apple Pay and Google Pay.",
    image: "/flow/pay.jpg",
  ...
  },
  {
    ...
    body: "Swipe normally. If you qualify, YOURS covers it.",
    image: "/flow/credit.jpg",
    alt: "Phone wallet ready to tap",
  },
  {
    id: "cash",
    title: "Your spend builds Yours Score.",
    body: "History becomes rank. Rank decides coverage.",
    image: "/flow/cash.jpg",
